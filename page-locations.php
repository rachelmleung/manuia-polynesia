	...
	<div id="primary" class="site-content">
		<div class="main-content" role="main">
            ...
            <div class="schedule-button">
                    <a class="button" href="<?php echo site_url('/schedule/venues/daly-city-studio') ?>">View Daly City Classes</a>
                </div>
                    <br>
                ...
                <div class="schedule-button">
                    <a class="button" href="<?php echo site_url('/schedule/venues/hayward-location') ?>">View Hayward Classes</a>
                </div>
                    <br>
